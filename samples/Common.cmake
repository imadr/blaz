...
if (EMSCRIPTEN)
    ...
    set_property(TARGET ${SAMPLE_NAME} PROPERTY VS_DEBUGGER_WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}/bin/${SAMPLE_NAME}/$<CONFIG>/")
    ...
    add_custom_target(${SAMPLE_NAME}_INTERNAL_DATA
        COMMAND ${CMAKE_COMMAND} -E copy_directory "${CMAKE_CURRENT_SOURCE_DIR}/../internal_data/" ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/$<CONFIG>/internal_data
    )
